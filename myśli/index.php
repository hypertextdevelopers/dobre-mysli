...
<head>
    ...
    <title>Dobre Myśli | Myśli</title>
    <link href="../styles/large-thoughts.css" rel="stylesheet">
    ...
    <script src="../js/thoughts-elements-controller.js"></script>
</head>
<body>
    <div class="wrapper" id="terapy-wrapper">
        ...
        <div class="thoughts-header" id="thoughts-header">
            <header>
                <h1>Dobre myśli</h1>
    ...
    <div class="thoughts-perf">
        <div class="thoughts-text-main" id="thoughts-text-main"></div>
    </div>

...
<head>
    ...
    <title>Dobre Myśli | O mnie</title>
    <link href="../styles/large-about.css" rel="stylesheet">
    ...
    <script src="../js/about-elements-controller.js"></script>
</head>
<body>
    ...
    <div class="about-perf">
        <div class="about-text-main" id="about-text-main"></div>
    </div>
